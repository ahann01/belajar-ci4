            ...
            <div class='card-body p-4'>
                ...
                <form action='<?= base_url($isEdit ? 'buku/update/' . $buku['id'] :
                        ...
                        <div class='col-md-6'>
                            ...
                            <div class='mb-3'>
                                ...
                                <input type='text' name='kode_buku'
                                    class='form-control <?=
                                                        isset($errors['kode_buku']) ? 'is-invalid' : '' ?>'
                                    value='<?= esc(old(
                                                'kode_buku',
                                                $buku['kode_buku'] ?? ''
                                            )) ?>'
                    ...
                    <div class='mb-3'>
                        ...
                        <textarea name='deskripsi' rows='4' class='form-control' placeholder='Ringkasan isi buku (opsional)'><?= esc(old('deskripsi', $buku['deskripsi'] ?? '')) ?></textarea>
                    </div>
