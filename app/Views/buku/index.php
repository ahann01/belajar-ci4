 ...
 * @var array<int, array<string, mixed>> $buku
...
<form method='GET' action='<?= base_url('buku') ?>' class='mb-4'>
    <div class='input-group'>
        <input type='text' name='q' class='form-control' placeholder='Cari judul, penulis, atau penerbit...'
            value='<?= esc($keyword) ?>'>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class='text-center'>
                    ...
                    <a href='<?= base_url('buku/hapus/' . $b['id']) ?>' class='btn btn-sm btn-danger' title='Hapus'
