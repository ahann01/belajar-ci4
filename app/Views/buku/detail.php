            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>:
                                <?php if ($buku['nama_kategori']): ?>
                                    <span class="badge bg-info"><?= esc((string) $buku['nama_kategori']) ?></span>
                    ...
                    <p class="text-justify mt-3">
                        <?= $buku['deskripsi'] ? esc((string) $buku['deskripsi']) : '<i class="text-muted">Tidak ada deskripsi tersedia.</i>' ?>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body text-center">
                    <div class="mb-3">
                        ...
                        <span
                            class="display-4 fw-bold text-<?= $buku['stok'] > 5 ?
                    ...
                    <div class="d-grid gap-2 mt-4">
                        ...
                        <button type="button" class="btn btn-outline-danger"
                            onclick="if(confirm('Hapus buku ini?')) window.location.href='<?= base_url('buku/hapus/' . $buku['id']) ?>'">
